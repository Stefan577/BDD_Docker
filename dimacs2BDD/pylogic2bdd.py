...
def main():
    ...
    command = f"/bin/bash -c 'cd /app/Logic2BDD/bin && ./Logic2BDD /mnt/data/{var_file_name} /mnt/data/{exp_file_name} && cp /app/BDD_Docker/bin/unknown.dddmp /mnt/data/{name}.dddmp'"
